...
from tri_loss.model.model_baseline_mask import Model
...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_mask')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_mask/ckpt_best.pth')
...
def main():
    ...
    for ep in range(start_ep, cfg.total_epochs):
        ...
        while not epoch_done:
            ...
            feat, logit1, logit_mask = model_w(ims_var, labels_var)

            loss1 = softmax_criterion(logit1, labels_var)
            loss2 = softmax_criterion(logit_mask, mask_labels_var)
            loss3 = loss1+loss2
