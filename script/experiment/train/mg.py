...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('--partition_path', type=str, default='/home/dff/MFR/FaceRecognition/script/pkl/mg.pkl')
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/webface/mg')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/webface/mg/ckpt_best.pth')
