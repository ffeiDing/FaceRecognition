...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('--partition_path', type=str, default='/home/dff/MFR/FaceRecognition/script/pkl/black.pkl')
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/webface/black')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/webface/black/ckpt_best.pth')
        ...
        parser.add_argument('--staircase_decay_at_epochs',
                            type=eval, default=(20, 60, 100)) # 20 60 100
