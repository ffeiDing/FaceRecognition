...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('--partition_path', type=str, default='/ssd_datasets/dff/GuGuGirls/partition.pkl')
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/f/GuGuGirls/FaceRecognition/logs')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/f/GuGuGirls/FaceRecognition/logs/ckpt_best.pth')
