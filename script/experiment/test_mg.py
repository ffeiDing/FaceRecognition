...
from tri_loss.model.model_baseline import Model
...
class Config(object):
    def __init__(self):
        ...
        #parser.add_argument('--partition_path', type=str, default='/home/dff/f/data/faces_webface_112x112_raw_image/ori.pkl')
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_wo_pretrained')
        #parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/bassline_new')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_wo_pretrained/ckpt_best.pth')
        #parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/bassline_new/ckpt_best.pth')
...
def main():
    ...
    for ep in range(start_ep, cfg.total_epochs):
        ...
        while not epoch_done:
            ...
            feat, logit1 = model_w(ims_var, labels_var)
