...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('-d', '--sys_device_ids', type=eval, default=(7,))
        parser.add_argument('-r', '--run', type=int, default=1)
        parser.add_argument('--set_seed', type=str2bool, default=False)
        parser.add_argument('--partition_path', type=str, default='/content/drive/My Drive/MTCNN_align_600id/test_partition.pkl')
