...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_stn_pretrained_bias/')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_stn_pretrained_bias/ckpt_best.pth')
