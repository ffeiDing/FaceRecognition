...
from tri_loss.utils.utils_convert import *
# from tri_loss.utils.utils import *
# from tri_loss.utils.utils_convert import tight_float_str as tfs
...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_stn_test_128')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_stn_test_128/resnet50.pth')
...
def main():
    ...
    #save_ckpt(modules_optims, 0, 0, osp.join(cfg.exp_dir, 'resnet50.pth'))
