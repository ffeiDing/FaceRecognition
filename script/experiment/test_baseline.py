...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/baseline_wo_pretrained')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/baseline_wo_pretrained/ckpt_best.pth')
        parser.add_argument('--model', type=str, default='Resnet50')
        
        parser.add_argument('--base_lr', type=float, default=0.01)#
        parser.add_argument('--lr_decay_type', type=str, default='warmup',
                            choices=['exp', 'staircase', 'warmup'])
        parser.add_argument('--exp_decay_at_epoch', type=int, default=1000)  # 41
        parser.add_argument('--staircase_decay_at_epochs',
                            type=eval, default=(0, 1000, 1000)) # 20 60 100
