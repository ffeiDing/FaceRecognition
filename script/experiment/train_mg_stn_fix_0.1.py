...
from tri_loss.model.model_stn import Model
...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('--rotate_prob', type=float, default=0)
        parser.add_argument('--rotate_degree', type=float, default=0)
        parser.add_argument('--mirror', type=str2bool, default=False)
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_stn_test_fixed_0.1')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_stn_fixed_0.1/ckpt.pth')
        parser.add_argument('--model', type=str, default='Resnet50')
        
        parser.add_argument('--base_lr', type=float, default=0.01)#
        parser.add_argument('--lr_decay_type', type=str, default='staircase',
                            choices=['exp', 'staircase', 'warmup'])
        parser.add_argument('--exp_decay_at_epoch', type=int, default=120)  # 41
        parser.add_argument('--staircase_decay_at_epochs',
                            type=eval, default=(120, 60, 100))
