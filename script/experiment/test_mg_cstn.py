...
from tri_loss.model.model_cstn import Model
...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_cstn_wo_pretrained')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_cstn_wo_pretrained/ckpt_best.pth')
