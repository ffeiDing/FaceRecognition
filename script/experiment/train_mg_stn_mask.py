...
class Config(object):
    def __init__(self):
        ...
        parser.add_argument('--exp_dir', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_stn_mask_1')
        parser.add_argument('--model_weight_file', type=str, default='/home/dff/MFR/FaceRecognition/logs/mg_stnmask_1/ckpt_best.pth')
...
def main():
    ...
    for ep in range(start_ep, cfg.total_epochs):
        ...
        while not epoch_done:
            ...
            feat, logit1, logit3, mask_logit = model_w(ims_var, labels_var)

            loss1 = softmax_criterion(logit1, labels_var)
            loss2 = softmax_criterion(logit3, labels_var)
            loss3 = softmax_criterion(mask_logit, mask_labels_var)
