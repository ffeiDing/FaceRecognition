...
from .resnet_baseline import resnet50, resnet152, resnet101
import time
...
class Model(nn.Module):
    def __init__(self, last_conv_stride=11, num_classes=13164, is_RPP=True, basenet='Resnet50', loss='Cosface', is_pool=True):
        ...
        if self.loss == "Softmax":
            ...
            self.id_classifier_mask = nn.Linear(self.feature_in_dim, 2, bias=False)#.apply(weights_init_kaiming)
            weights_init_classifier(self.id_classifier_mask)
    ...
    def forward(self, img, target):
        ...
        if self.training==True:
            if self.loss == "Softmax":
                ...
                id_logit_mask = self.id_classifier_mask(id_feat1)
            else:
        ...
        return id_feat1, id_logit1, id_logit_mask
